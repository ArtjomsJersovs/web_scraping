...
def extract_transform():
    ...
    #Preprocess dataframe and match records to exclude duplicates
...
if __name__ == '__main__':
    ...
    main_df = extract_transform()
    load(database=r"C:\Users\artjoms.jersovs\github\Scraping\web_scraping\ss_lv_marketplace\ss_db.db", main_df=main_df)
